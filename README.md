...
mutation MyMutation($address: String, $description: String, $category: String, $title: String, $contact_owner: String, $created_at: timestamptz, $email: String, $lat: String, $lng: String, $mobile_no: String) {
